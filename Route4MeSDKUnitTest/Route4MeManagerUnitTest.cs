    ...
    public class OrdersGroup
    {
        ...
        public static void CreateOrderTest(TestContext context)
        {
            ...
            var order = new Order()
            {
                ...
                day_scheduled_for_YYYYMMDD = dtTomorrow.ToString("yyyy-MM-dd"),
        ...
        public void AddScheduledOrderTest()
        {
            ...
            var orderParams = new Order()
            {
                ...
                day_scheduled_for_YYYYMMDD = "2017-12-20",
        ...
        public void CreateOrderWithOrderTypeTest()
        {
            ...
            route4Me.RemoveOrders(new string[] { result.order_id.ToString() }, out string errorString2);
        }
